...
Bu sənəd Zirva Məktəb İdarəetmə Platformasının məlumatların qorunması mexanizmlərini təsvir edir. Sənəd Azərbaycan Respublikası Elm və Təhsil Nazirliyinin № VM26005443 (24.04.2026) tarixli müraciətinə tam şəffaflıq prinsipinə uyğun olaraq cavab kimi hazırlanmışdır.

**Müzakirə olunan əsas məsələlər:**

Zirva rəhbərliyi bu sənəddə dürüstlük prinsipinə sadiq qalır. Platformamızın məlumat rezidentliyi sahəsindəki hazırkı vəziyyəti aşağıda açıqca bəyan olunur:

**Kritik faktı açıqlayır:** Zirva platformasının verilənlər bazası hazırda Amazon Web Services (AWS) **ap-northeast-2** regionunda — **Seul, Cənubi Koreya**da — yerləşdirilmişdir. Bu vəziyyət Azərbaycan Respublikasının "Şəxsi məlumatlar haqqında" Qanununun (18.03.1998, №461-IQ) 8-ci maddəsinin tələbləri ilə ziddiyyət yarada bilər. Zirva bu riski tam qəbul edir, onun aradan qaldırılması üçün konkret, tarixli bir plan tərtib etmişdir (bax: Bölmə 4) və bu məsələ üzrə Nazirliyin rəhbərliyini gözləyir.
...
| Maddə 8 | Transsərhəd ötürmə | **⚠️ Cari vəziyyət: Seoul, Cənubi Koreya — aradan qaldırılması tələb olunur; bax Bölmə 4** |
...
- [DOLDURUN: Kibertəhlükəsizlik üzrə mövcud fərman/qərar nömrəsi]
...
|---|---|---|---|---|
| Ad, soyad | Bütün istifadəçilər | Platforma girişi, kommunikasiya | Hesab aktiv olduğu müddət + 1 il | Məcburi |
...
| Mesaj məzmunu | Bütün istifadəçilər | Daxili kommunikasiya | 2 il | Funksional |
...
>
> Bu vəziyyət "Şəxsi məlumatlar haqqında" Azərbaycan Respublikasının Qanununun (18.03.1998, №461-IQ) Maddə 8-i ilə ziddiyyət yarada bilər. Həmin maddə, şəxsi məlumatların Azərbaycan Respublikasından kənara, kifayət qədər qorunma mexanizmi olmayan ölkələrə ötürülməsini məhdudlaşdırır.
>
...
- Supabase SOC 2 Type II sertifikatı mövcuddur
- Supabase AWS Frankfurt (EU-West-1) və ya Ireland (EU-West-1) nodelarına miqrasiya infrastrukturuna malikdir
...
**Hədəf:** Supabase verilənlər bazasını AWS ap-northeast-2 (Seul) → AWS eu-west-1 (İrlandiya) və ya eu-central-1 (Frankfurt, Almaniya) bölgəsinə köçürmək.

**Tədbirlər:**
1. Supabase Dashboard-da yeni proje yaradılır (EU-West region)
2. Mövcud məlumatların tam ehtiyat nüsxəsi (backup) alınır
...
7. Köhnə node 30 gün keçid müddəti sonunda söndürülür
...
**Nəticə:** Avropa İttifaqı GDPR standartlarına uyğun region; Azərbaycan ilə hüquqi çərçivə mövcuddur
...
**Seçim B:** Bakıda özəl data mərkəzinə miqrasiya  
...
3. Supabase Data Processing Agreement (Məlumat İşləmə Müqaviləsi) mövcuddur
...
| Şagird fotoşəkli | İxtiyari — şagird/valideyn tərəfindən yükləyir |
...
- Hər istifadəçi yalnız öz məlumatlarına giriş edə bilər
- Müəllim yalnız öz sinifinin məlumatlarına giriş edə bilər
- Valideyn yalnız öz övladının məlumatlarına giriş edə bilər
...
- Razılıq verilən platform versiyası (şərtlər dəyişdikdə yenidən razılıq tələb edilsin deyə)
...
| 7 — Aradan Qaldırma | Köküsahə (root cause) aradan qaldırılır, sistem bərpa olunur, post-mortem yazılır | Texniki komanda | 5 iş günü ərzində |
...
| **Supabase** | Verilənlər bazası, auth | Bütün platforma məlumatları (şifrəli) | — | Seoul ⚠️ → EU (planlı) | Data Processing Agreement |
...
Anthropic Claude API istifadəsinin şəffaflığı məsələsini açıqca bəyan etmək vacibdir:
...
Hər istifadəçi öz platformadakı bütün məlumatlarını ixrac edə bilər:
...
Məktəb administratorları məktəbləri üçün toplu məlumat ixracı həyata keçirə bilər — bu, başqa sistemlərə miqrasiya üçün faydalıdır.

### 13.3 Nazirlik Səviyyəsindəki İxrac

Nazirlik istifadəçiləri analitik hesabat formalarında (PDF, Excel) məlumat ixracı edə bilər. Nazirliyin tələbi ilə xam verilənlər bazası ixracı (PostgreSQL dump) da mümkündür.
...
Nazirlik (`ministry`) roluna sahib istifadəçilər aşağıdakı məlumatlara **yalnız oxuma** girişi var:
...
- Platform istifadə statistikası (aktiv istifadəçi sayı, giriş tezliyi)
...
graph TB
    ...
    subgraph "Supabase Verilənlər Bazası"
        direction TB
        SEOUL["⚠️ CARI: AWS ap-northeast-2 Seoul, Cənubi Koreya"]
...
| 4 | **Nazirlik DPA:** Zirva ilə Nazirlik arasında rəsmi bir Məlumat İşləmə Müqaviləsi (Data Processing Agreement) imzalanması nəzərdə tutulurmu? Əgər bəli ise, Nazirliyin standart DPA şablonu mövcuddurmu? | Hüquqi sənəd tələb olunur |
