...
export default function ResetPassword() {
  ...
  return (
    <div className="min-h-screen bg-surface flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-lg border border-border-soft p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="font-serif text-2xl text-gray-900 mb-2">{t('new_password_set')}</h1>
