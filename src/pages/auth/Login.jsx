...
export default function Login() {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen">
      {/* Left branding panel */}
      <div className="hidden lg:flex lg:w-[460px] xl:w-[520px] bg-gradient-to-br from-[#534AB7] to-[#3730A3] min-h-screen flex-col items-center justify-center text-white p-12 shrink-0">
        <div className="w-full max-w-sm space-y-12">
          {/* Logo + app name */}
          <div className="flex items-center gap-3">
            <ZirvaIcon />
            <span className="font-serif text-2xl tracking-tight">Zirva</span>
          </div>
      ...
      {/* Right form panel */}
      <div className="flex-1 bg-white min-h-screen flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          {showReset ? (
            ...
            <div>
              ...
              {resetSent ? (
                <div className="bg-green-50 border border-green-200 rounded-xl px-4 py-4 text-sm text-green-700 mb-6">
            ...
            <>
              <div className="mb-8">
                <h1 className="font-serif text-3xl text-gray-900 mb-2">Xoş gəldiniz</h1>
