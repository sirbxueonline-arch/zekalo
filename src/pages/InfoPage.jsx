...
const T = {
  ...
  tr: {
    ui_contact_us:       'Bize Ulaşın',
    ui_whats_included:   'Neler dahil',
    ui_quick_facts:      'Hızlı bilgiler',
    ui_programme:        'Program',
    ui_age_range:        'Yaş aralığı',
    ui_ib_code:          'IB Kodu',
    ui_related:          'İlgili programlar',
    ui_questions:        'Sorularınız mı var?',
    ui_questions_body:   'Gerçek bir insanla konuşun. Genellikle bir saat içinde yanıtlıyoruz.',
    ui_book_demo:        'Demo talep et',
    ui_learn_more:       'Daha fazla',
    ui_ages:             'Yaş',
    ui_years:            'yaş',
    ui_ib_programme:     'IB Programı',
    ui_state_schools:    'Devlet Okulları',
    ui_page_not_found:   'Sayfa bulunamadı',
    ui_back_home:        '← Ana sayfaya dön',
    'ib-diploma_title':  'IB Diploma (DP)',
    'ib-diploma_subtitle': 'IB Diploma Programı için tam destek',
    'ib-diploma_body':   `IB Diploma Programı (DP), 16–19 yaş arası öğrenciler için kapsamlı bir üniversite hazırlık kursudur. Zirva, DP'nin tüm yönetimini sağlar: ders seçimi, değerlendirme kriterlerinin takibi (A–D ölçeği), CAS yönetimi, Bilgi Teorisi belgelemesi ve Uzatılmış Deneme iş akışı dahil. Platformumuz, sınav kaydı ve e-ödev teslimi için IBIS ile doğrudan entegre olur.`,
    'ib-career_title':   'IB Kariyer (CP)',
    'ib-career_subtitle':'IB Kariyer Odaklı Program için özel araçlar',
    'ib-career_body':    `IB Kariyer Odaklı Program (CP), IB'nin titizliğini kariyer odaklı çalışmayla birleştirir. Zirva, CP okullarını kişiselleştirilmiş öğrenme kayıtları, yansıtıcı proje yönetimi, hizmet öğrenimi takibi ve dil gelişimi belgeleme ile destekler — tek bir platformda.`,
    'ib-myp_title':      'IB Orta Yıllar (MYP)',
    'ib-myp_subtitle':   'Ortak Araştırma Programı planlaması',
    'ib-myp_body':       `IB Orta Yıllar Programı (MYP), 11–16 yaş arası öğrenciler için akademik zorluk çerçevesi sunar. Zirva'nın MYP araçları şunları içerir: birim planlayıcı işbirliği, disiplinlerarası öğrenme takibi, kriter referanslı değerlendirme (A–D), MYP eDeğerlendirme hazırlığı ve kişisel proje yönetimi.`,
    'ib-pyp_title':      'IB İlk Yıllar (PYP)',
    'ib-pyp_subtitle':   'Küçük öğrenciler için aynı güçlü destek',
    'ib-pyp_body':       `IB İlk Yıllar Programı (PYP), genç öğrencileri yaşam boyu öğrenme yolculuğunda özenli ve aktif katılımcılar olarak yetiştirir. Zirva, PYP okullarını sergi planlaması, disiplinlerarası tema takibi, portfolio yönetimi ve öğrenci profili belgeleme ile destekler.`,
    'government-schools_title':    'Devlet Okulları',
    'government-schools_subtitle': 'Azerbaycan devlet okulları için özel mod',
    'government-schools_body':     `Zirva'nın Devlet Okulu sürümü, özellikle Azerbaycan devlet okulları için geliştirilmiştir. Milli Eğitim Bakanlığı raporlama sistemi ile tam entegrasyon, E-Gov.az dışa aktarma, ASAN Xidmət uyumluluğu, ulusal 10 puanlık notlandırma ve otomatik uyumluluk raporlarını içerir. Tüm veriler yerel mevzuata tam uygunlukla Azerbaycan sunucularında saklanır.`,
    'ib-pyp_hl':     ['Disiplinlerarası temalar','Sergi planlaması','Portfolio yönetimi','Öğrenci profili takibi'],
    'ib-myp_hl':     ['Birim planlayıcı işbirliği','Disiplinlerarası takip','A–D kriter değerlendirmesi','Kişisel proje yönetimi'],
    'ib-diploma_hl': ['Ders seçimi ve programlama','A–D değerlendirme takibi','CAS ve TOK yönetimi','Uzatılmış Deneme iş akışı','IBIS entegrasyonu'],
    'ib-career_hl':  ['Kişiselleştirilmiş öğrenme kayıtları','Yansıtıcı proje takibi','Hizmet öğrenimi belgelemesi','Dil gelişimi'],
    'government-schools_hl': ['Milli Eğitim Bakanlığı entegrasyonu','E-Gov.az ve ASAN Xidmət dışa aktarma','Ulusal 10 puanlık notlandırma','Otomatik uyumluluk raporları','Azerbaycan sunucularında veri saklama'],
    ct_eyebrow:      'İletişim',
    ct_heading:      'Konuşalım.',
    ct_sub:          'Her mesajı gerçek insanlar okur. Genellikle bir saat içinde yanıtlıyoruz.',
    ct_name:         'Ad',
    ct_email:        'E-posta',
    ct_school:       'Okul',
    ct_phone:        'Telefon',
    ct_message:      'Mesaj',
    ct_ph_name:      'Rauf Aliyev',
    ct_ph_school:    'Bakü Uluslararası Okulu',
    ct_ph_message:   'Okulunuz ve ihtiyaçlarınız hakkında yazın…',
    ct_send:         'Mesaj gönder',
    ct_sending:      'Gönderiliyor…',
    ct_privacy:      'Bilgileriniz gizli kalır. Spam yok.',
    ct_success_title:'Aldık — teşekkürler!',
    ct_success_body: 'bir saat içinde yanıt vereceğiz.',
    ct_back:         'Ana sayfaya dön',
    rel_pyp: 'IB İlk Yıllar',
    rel_myp: 'IB Orta Yıllar',
    rel_dp:  'IB Diploma',
    rel_cp:  'IB Kariyer',
  },
}
